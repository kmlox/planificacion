...
<?php
    if($model->id_CMO==NULL){
        //Imagen sólo en crear
            ...
            'ajax'=>array(
            'type'=>'POST',
            'url'=>CController::createUrl('cMO/SelectGrado'),
            'update'=>'#id_grado',
            ...
            'ajax'=>array(			
            'type'=>'POST',
            'url'=>CController::createUrl('cMO/SelectAsignatura'),
...
<div class="row" align="left">    
        <?php echo $form->textAreaGroup($model,'descripcion_CMO', array('widgetOptions'=>array('htmlOptions'=>array('rows'=>6, 'cols'=>1)))); ?>
</div>

...
class Administrador extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_administrador', 'required'),
			array('id_administrador', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_administrador', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_administrador',$this->id_administrador,true);

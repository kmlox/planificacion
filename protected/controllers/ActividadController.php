    ...
    */
    public function actionCreate()
    {
        ...
        if(isset($_POST['Actividad']))
        {
            ...
            if($model->save()){                
                $indicadorselected=$_POST['Actividad']['IndicadoresIds'];
                ...
                while ($tok !== false) {
                    if(is_numeric($tok)){
                        Yii::app()->db->createCommand()->insert('actividad_tiene_indicador',array('id_actividad'=>$id_actividad,'id_indicador'=>$tok));
                    }
                    $tok = strtok(" ,");                            
                }

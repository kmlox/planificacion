...
class AsignaturaController extends Controller
{
    ...
    */
    public function accessRules()
    {
        return array(
            ...
            'actions'=>array('index','view','create','update','admin','eliminar','selectgrado','selectid'),
            'roles'=>array('admin'),
            ),          
    ...
    public function actionCreate()
    {
       $model=new Asignatura;
        ...
        if(isset($_POST['Asignatura']))
        {
            ...
            if($model->save())
                $this->redirect(array('view?id='.$model->id_asignatura));
        }
    ...
    */
    ...
    {
        Yii::app()->db->createCommand()->delete('asignatura', 'id_asignatura=:id', array(':id'=>$id));
